...
export default function Theme() {
  ...
  return (
    <motion.div
      ...
      className={`${style.block} w-[270px] h-[140px] rounded-[8px] absolute  top-[130px] right-[130px] border-[2px] flex flex-wrap justify-center items-center p-[10px] gap-[10px] `}
    >
      <motion.div
